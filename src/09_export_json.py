"""Export per-chart JSON for the static site, plus a data.js bundle for offline use."""
import json
import os
...
write_json("chapters_by_year.json", chapters_by_year)

print("\nJSON -> ", DATA_DIR)

# Bundle everything into a single data.js so the site works without fetch().
